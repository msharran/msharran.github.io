...
| **Cursor** | [Cursor partnered with SpaceXAI to train Grok 4.5](https://x.com/cursor_ai/status/2074915744999969059) — a first-party model alongside **Composer 2.5** (Kimi K2.5 lineage, which I had wanted to try). Cursor later [doubled usage limits on individual and team plans](https://x.com/cursor_ai/status/2079615536963485815) for Grok, Composer, and future Cursor-hosted models. I skipped Grok — frontier weight class, burns the first-party pool faster. One default model, no daily lottery. Cancelled Codex, subscribed this month. Limits feel generous: ~2% used in two days, more throughput than my Codex peak. Composer 2.5 with fast mode off for now; if I still have quota at month-end, I will flip fast mode on and burn the rest. Staying for a few months unless something breaks. |
