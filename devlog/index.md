...
<section class="devlog" aria-labelledby="devlog-title">
  ...
  <ol class="devlog-list">
    <li class="devlog-item">
      <time class="devlog-date" datetime="2026-08-23">August 23, 2026</time>
      <a class="devlog-link" href="{{ '/devlog/20260823-planning-trip-cursor-cloud-agent/' | relative_url }}">Planning a Trip from a Cursor Cloud Agent</a>
    </li>
    <li class="devlog-item">
      <time class="devlog-date" datetime="2026-08-18">August 18, 2026</time>
      <a class="devlog-link" href="{{ '/devlog/20260818-one-claude-md-many-harnesses/' | relative_url }}">One CLAUDE.md, Many Harnesses</a>
    </li>
    <li class="devlog-item">
      <time class="devlog-date" datetime="2026-08-18">August 18, 2026</time>
    ...
    <li class="devlog-item">
      ...
      <a class="devlog-link" href="{{ '/devlog/20260724-building-redis-server-zig-part-2-completing-the-server/' | relative_url }}">Building a Redis Server in Zig, Part 2: Completing the Server</a>
    </li>
    <li class="devlog-item">
